                ...
                switch (node.Type)
                {
                    ...
                    case "approval":
                        ...
                        try
                        {
                            ...
                            var appServiceType = Type.GetType("sssunum.Approvals.IApprovalAppService, sssunum.Application")
                                ?? throw new InvalidOperationException("IApprovalAppService type not found in sssunum.Application assembly");
                            ...
                            var submitInputType = Type.GetType("sssunum.Approvals.Dto.SubmitApprovalInput, sssunum.Application")!;
