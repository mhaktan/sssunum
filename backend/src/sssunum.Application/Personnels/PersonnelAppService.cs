        ...
        protected override IQueryable<Personnel> CreateFilteredQuery(PagedPersonnelResultRequestDto input)
        {
            return Repository.GetAll()
                .WhereIf(!input.Keyword.IsNullOrWhiteSpace(), x =>
                    ...
                    (x.BadgeNumber != null && x.BadgeNumber.Contains(input.Keyword)) ||
                ...
                .WhereIf(!input.BadgeNumber.IsNullOrWhiteSpace(), x => x.BadgeNumber != null && x.BadgeNumber.Contains(input.BadgeNumber))
