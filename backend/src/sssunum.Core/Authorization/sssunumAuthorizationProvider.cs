...
namespace sssunum.Authorization
{
    public class sssunumAuthorizationProvider : AuthorizationProvider
    {
        ...
        {
            return new LocalizableString(name, sssunumConsts.LocalizationSourceName);
        }
    }
}
