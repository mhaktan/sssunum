...
using sssunum.Authorization;
using sssunum.Entities;

namespace sssunum.EntityFrameworkCore.Seed
{
    /// <summary>
    ...
    public class DefaultUserSeeder
    {
        ...
        public void Seed()
        {
            ...
            try
            {
                ...
                {
                    customRole_0 = new AppRole { Name = "LineMechanic", DisplayName = "Line Mechanic", Description = "Hat bakım teknisyeni — snag raporlar, üstlenir, işlemi girerek CRS onayına gönderir.", IsSystem = false, IsActive = true };
                ...
                var customPerms_0 = new[] { "SnagReport.Create", "SnagReport.Read", "SnagReport.Update", "SnagReport.Delete", "SnagReport.ChangeStatus", "Aircraft.Read", "Personnel.Read" };
                ...
                {
                    customRole_1 = new AppRole { Name = "CertifyingStaff", DisplayName = "Certifying Staff", Description = "Sertifikalı yetkili personel — snag raporunu inceler, onaylayarak kapatır veya revize için geri gönderir.", IsSystem = false, IsActive = true };
                ...
                var customPerms_1 = new[] { "SnagReport.Read", "SnagReport.Update", "SnagReport.ChangeStatus", "Aircraft.Read", "Personnel.Read" };
