...
{
    [DependsOn(typeof(sssunumCoreModule), typeof(AbpEntityFrameworkCoreModule))]
    public class sssunumEntityFrameworkCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            Configuration.Modules.AbpEfCore().AddDbContext<sssunumDbContext>(options =>
            {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(sssunumEntityFrameworkCoreModule).GetAssembly());
        }
    }
}
