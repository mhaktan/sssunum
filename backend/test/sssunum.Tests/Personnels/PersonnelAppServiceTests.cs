...
namespace sssunum.Tests.Personnels
{
    public class PersonnelAppServiceTests
    {
        ...
        public void Repository_GetAll_ShouldReturnQueryable()
        {
            ...
            var entities = new[]
            {
                new Personnel { Id = 1, FirstName = "Test firstName", LastName = "Test lastName", BadgeNumber = "Test badgeNumber", Role = 0 },
                new Personnel { Id = 2, FirstName = "Test firstName", LastName = "Test lastName", BadgeNumber = "Test badgeNumber", Role = 0 },
            }.AsQueryable();
        ...
        public async Task Create_ShouldInsertEntity()
        {
            ...
            {
                FirstName = "Test firstName", LastName = "Test lastName", BadgeNumber = "Test badgeNumber", Role = 0
            };

            _repositoryMock.Setup(r => r.InsertAndGetIdAsync(It.IsAny<Personnel>()))
                .ReturnsAsync(1);
            _repositoryMock.Setup(r => r.GetAsync(It.IsAny<long>()))
                .ReturnsAsync(new Personnel { Id = 1, FirstName = "Test firstName", LastName = "Test lastName", BadgeNumber = "Test badgeNumber", Role = 0 });
