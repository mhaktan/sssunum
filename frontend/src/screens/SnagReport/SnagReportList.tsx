...
const COLUMNS: TableColumn[] = [
  ...
  { field: 'criticality', header: 'Criticality', sortable: true, filterType: 'radio', filterOptions: [{ label: 'AOG', value: '0' }, { label: 'MEL', value: '1' }, { label: 'Routine', value: '2' }], html: (row: Record<string, unknown>) => { const m: Record<string, string> = {'0': 'AOG', '1': 'MEL', '2': 'Routine'}; return m[String(row.criticality ?? '')] ?? String(row.criticality ?? '\u2014'); } },
  ...
  { field: 'status', header: 'Status', sortable: true, filterType: 'radio', filterOptions: [{ label: 'Open', value: '0' }, { label: 'InProgress', value: '1' }, { label: 'PendingCRS', value: '2' }, { label: 'Closed', value: '3' }, { label: 'Cancelled', value: '4' }], html: (row: Record<string, unknown>) => { const m: Record<string, string> = {'0': 'Open', '1': 'InProgress', '2': 'PendingCRS', '3': 'Closed', '4': 'Cancelled'}; return m[String(row.status ?? '')] ?? String(row.status ?? '\u2014'); } },
